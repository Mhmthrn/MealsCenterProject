...
public class ReusableMethods extends TestBaseRapor{
    ...
    // MealsCenter methodlari
     static Actions actions=new Actions(Driver.getDriver());

     // mehmet harun yazdi
    public static void homePozitifLoginTest(){
        ...
        String expectedResult="Hungry? We got you";
        String actualResult= homePage.loginVerifiyItemHome.getText();
    ...
    // mehmet harun yazdi
    // adres girip urun siparis etme methodu retaaurant Sttarbucks urun kahve

    public static void starbucksMenuVisibleTestHome(){
        ...
        Assert.assertTrue(homePage.starbucksMenuApperItem.isDisplayed());
